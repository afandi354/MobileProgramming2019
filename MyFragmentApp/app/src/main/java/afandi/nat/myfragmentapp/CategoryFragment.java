...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btn_detail_category){
            ...
            mBundle.putString(DetailCategoryFragment.EXTRA_NAME, "Klik 'Buton Profile' untuk menuju halaman profile");
            String description ="'Button Dialog' untuk memilih dosen";
